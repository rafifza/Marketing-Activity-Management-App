...
class AktivitasKedepanWidget extends StatelessWidget {
  final List<AktivitasKedepanModel> aktivitasList;

  const AktivitasKedepanWidget({super.key, required this.aktivitasList});
